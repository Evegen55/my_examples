...
public class Location {
    ...
    public static String convert(double coordinate, int outputType) {
        ...
        sb.append(decimalFormat.format(coordinate));
        return sb.toString();
    }
    ...
    public static double convert(String coordinate) {
        ...
        final StringTokenizer stringTokenizer = new StringTokenizer(coordinate, ":");
        int tokens = stringTokenizer.countTokens();
        if (tokens < 1) {
            throw new IllegalArgumentException("coordinate=" + coordinate);
        }
        try {
            String degrees = stringTokenizer.nextToken();
            double val;
            if (tokens == 1) {
     ...
     * the WGS84 ellipsoid. This method synchronised by mResults
     *
    ...
    public float distanceTo(final Location location) {
        ...
        synchronized (mResults) {
            if (mLatitude != mLat1 || mLongitude != mLon1 ||
                    location.mLatitude != mLat2 || location.mLongitude != mLon2) {
                computeDistanceAndBearing(mLatitude, mLongitude,
                        location.mLatitude, location.mLongitude, mResults);
                mLat1 = mLatitude;
                mLon1 = mLongitude;
    ...
    public boolean equals(Object o) {
        ...
        if (mTime != location.mTime) return false;
        if (mElapsedRealtimeNanos != location.mElapsedRealtimeNanos) return false;
        if (Double.compare(location.mLatitude, mLatitude) != 0) return false;
        if (Double.compare(location.mLongitude, mLongitude) != 0) return false;
        if (mHasAltitude != location.mHasAltitude) return false;
        if (Double.compare(location.mAltitude, mAltitude) != 0) return false;
        if (mHasSpeed != location.mHasSpeed) return false;
        if (Float.compare(location.mSpeed, mSpeed) != 0) return false;
        if (mHasBearing != location.mHasBearing) return false;
        if (Float.compare(location.mBearing, mBearing) != 0) return false;
        if (mHasAccuracy != location.mHasAccuracy) return false;
        if (Float.compare(location.mAccuracy, mAccuracy) != 0) return false;
        if (mIsFromMockProvider != location.mIsFromMockProvider) return false;
        if (Double.compare(location.mLat1, mLat1) != 0) return false;
        if (Double.compare(location.mLon1, mLon1) != 0) return false;
        if (Double.compare(location.mLat2, mLat2) != 0) return false;
        if (Double.compare(location.mLon2, mLon2) != 0) return false;
        if (Float.compare(location.mDistance, mDistance) != 0) return false;
        if (Float.compare(location.mInitialBearing, mInitialBearing) != 0) return false;
        if (mProvider != null ? !mProvider.equals(location.mProvider) : location.mProvider != null) return false;
        return Arrays.equals(mResults, location.mResults);
    }
    ...
    public int hashCode() {
        int result;
        long temp;
        result = mProvider != null ? mProvider.hashCode() : 0;
        result = 31 * result + (int) (mTime ^ (mTime >>> 32));
        result = 31 * result + (int) (mElapsedRealtimeNanos ^ (mElapsedRealtimeNanos >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        result = 31 * result + (mHasSpeed ? 1 : 0);
        result = 31 * result + (mSpeed != +0.0f ? Float.floatToIntBits(mSpeed) : 0);
        result = 31 * result + (mHasBearing ? 1 : 0);
        result = 31 * result + (mBearing != +0.0f ? Float.floatToIntBits(mBearing) : 0);
        result = 31 * result + (mHasAccuracy ? 1 : 0);
        result = 31 * result + (mAccuracy != +0.0f ? Float.floatToIntBits(mAccuracy) : 0);
        result = 31 * result + (mIsFromMockProvider ? 1 : 0);
        temp = Double.doubleToLongBits(mLat1);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = Double.doubleToLongBits(mLon1);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = Double.doubleToLongBits(mLat2);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = Double.doubleToLongBits(mLon2);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        result = 31 * result + (mDistance != +0.0f ? Float.floatToIntBits(mDistance) : 0);
        result = 31 * result + (mInitialBearing != +0.0f ? Float.floatToIntBits(mInitialBearing) : 0);
        result = 31 * result + Arrays.hashCode(mResults);
        return result;
    }
}