...
public class LargestQuakes {
     ...
     * earthquakes and how many earthquakes that were from the source. You should readAndParseXMLFrom
     ...
     * earthquakes readAndParseXMLFrom in.
     */
     ...
     * @return
     */
    public ArrayList<QuakeEntry> getLargest(List<QuakeEntry> Data, int howMany) {
